    ...
    body: Container(height: double.infinity, decoration: const BoxDecoration(gradient: AppColors.gradientRB),
      child: SingleChildScrollView(child: Column(children: [
        ...
        TextButton.icon(
          ...
          icon: const Icon(Icons.person_add_rounded, color: Colors.white70, size: 18),
          label: Text('Naya Account Banao', style: TextStyle(color: Colors.white.withValues(alpha: 0.85), fontSize: 14, fontWeight: FontWeight.w600))),
